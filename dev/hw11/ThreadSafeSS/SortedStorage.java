...
public class SortedStorage<T extends Comparable<T>> implements StorageAnalyser<T>, Iterable<T>, Comparable<SortedStorage<T>>{
     ...
     * @author Shreesh Tripathi
     */
    public synchronized boolean delete(T val) throws ListCannotBeModified{
        Node<T> target = findNodeInList(val);
        Node<T> predecessor, successor;

        System.out.println("Thread " + Thread.currentThread().threadId() + " is deleting element: " + String.valueOf(val));
     ...
     * @author Shreesh Tripathi
     */
    public synchronized boolean find(T val){
        if (val == null){
     ...
     * @author Shreesh Tripathi
     */
    public synchronized boolean add(T new_val) throws ListCannotBeModified {
        // Start at the head of the list
        Node<T> temp, currNode = this.head;
        System.out.println("Thread " + Thread.currentThread().threadId() + " is adding element: " + String.valueOf(new_val));
     ...
     * @author Shreesh Tripathi
     */
    public synchronized void makeASet() throws ListCannotBeModified {
        this.isSet = true;
        Node<T> currNode = this.head;
     ...
     * @author Shreesh Tripathi
     */
    public synchronized void notASet(){
        this.isSet = false;
    }
